...
export const stepsItems = [
  {
    ...
    description:
      "We meet on-site to understand your goals, whether it's a strata complex's curb appeal or a private estate's sanctuary.",
    number: "Step 1",
    iconPath:
  ...
  },
  {
    ...
    description:
      "Our artisans bring the design to life using high-grade materials and professional-grade precision.",
    number: "Step 2",
    iconPath:
  ...
  },
  {
    ...
    description:
      "You receive a property that is not only beautiful today but engineered for health and durability for years to come.",
    number: "Step 3",
    iconPath:
