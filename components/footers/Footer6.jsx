    ...
    <div className="container">
      <div className="row pb-120 pb-sm-80 pb-xs-50">
        <div className="col-lg-3 text-gray mb-md-50">
          ...
          <div className="clearlinks">
            <strong>T.</strong>
            <a href="tel:+1 (604) 396 5472">+1 (604) 396 5472</a>
          </div>
          <div className="clearlinks">
            <strong>E.</strong>
            <a href="mailto:info@savileservices.ca">info@savileservices.ca</a>
          </div>
        </div>
      ...
      <div className="row text-gray">
        <div className="col-md-4 col-lg-3">
          <b>© Savile Services {new Date().getFullYear()}.</b>
        </div>
        <div className="col-md-7 offset-md-1 offset-lg-2 clearfix">
          <b>Based in Metro Vancouver, Canada.</b>
          {/* Back to Top Link */}
          <div
